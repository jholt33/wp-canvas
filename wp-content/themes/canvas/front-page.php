			...
			<div class="slider-parallax-inner">
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark" style="background-image: url('<?php bloginfo('template_directory');?>/images/slider/swiper/1.jpg');">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_two_fifth nobottommargin">
						<a href="http://vimeo.com/101373765" data-lightbox="iframe">
							<img src="<?php bloginfo('template_directory');?>/images/others/1.jpg" alt="Image">
							<span class="i-overlay"><img src="<?php bloginfo('template_directory');?>/images/icons/play.png" alt="Play"></span>
						</a>
					</div>
					...
					<div id="oc-portfolio" class="owl-carousel portfolio-carousel portfolio-nomargin carousel-widget" data-margin="1" data-pagi="false" data-autoplay="5000" data-items-xxs="1" data-items-xs="2" data-items-sm="3" data-items-lg="4">
						...
						<div class="oc-item">
							<div class="iportfolio">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="<?php bloginfo('template_directory');?>/images/portfolio/4/11.jpg" alt="Workspace Stuff">
									</a>
									<div class="portfolio-overlay">
										<a href="<?php bloginfo('template_directory');?>/images/portfolio/full/11.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
										<a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
									</div>
								</div>
								<div class="portfolio-desc">
					...
					<div class="container clearfix">
						...
						<ul class="testimonials-grid grid-3 clearfix nobottommargin">
							<li>
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="<?php bloginfo('template_directory');?>/images/testimonials/1.jpg" alt="Customer Testimonails"></a>
									</div>
							...
							<li>
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="<?php bloginfo('template_directory');?>/images/testimonials/2.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
							...
							<li>
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="<?php bloginfo('template_directory');?>/images/testimonials/7.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
							...
							<li>
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="<?php bloginfo('template_directory');?>/images/testimonials/4.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
							...
							<li>
								<div class="testimonial">
									<div class="testi-image">
										<a href="#"><img src="<?php bloginfo('template_directory');?>/images/testimonials/8.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
				...
				<div class="container clearfix">
					...
					<div id="oc-clients" class="owl-carousel owl-carousel-full image-carousel carousel-widget" data-margin="30" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xxs="2" data-items-xs="3" data-items-sm="4" data-items-md="5" data-items-lg="6" style="padding: 20px 0;">
						...
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/1.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/2.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/3.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/4.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/5.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/6.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/7.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/8.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/9.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="http://logofury.com/"><img src="<?php bloginfo('template_directory');?>/images/clients/10.png" alt="Clients"></a></div>
